from wolf import * ;  from sys import * ; from telethon import TelegramClient, functions, types ; from telethon.tl.types import InputMessagesFilterDocument ; from pathlib import Path; from wolf.wolfbot.commands import * ; import asyncio, os, traceback, sys, traceback, os, importlib, glob ; wolf = tgbot = bot.tgbot = client 
...
#####################################
plugin_channel = "@WolfPlugin"  #this is official plugin channel for wolfuserbot 
#####################################
...
async def a():
  ...
  os.system("rm wolf/modules/*.py") ; LOGS.info(f"Sucessfully connected with {o}{o2}{o3}{o4} check it by typing !wolf in any client's chat, type  !help for more info.")
  if len(argv) not in (1, 3, 4):
       await wolf.disconnect()
  else:
       await wolf.run_until_disconnected()
       

        

wolf.loop.run_until_complete(a())
